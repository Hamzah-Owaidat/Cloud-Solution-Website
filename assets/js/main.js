...
let text1 = document.getElementById("ours-text-1");
let text2 = document.getElementById("ours-text-2");
let bonnieCard = document.getElementById("bonnie-card");
let jeseCard = document.getElementById("jese-card");
let michaelCard = document.getElementById("michael-card");
let lanaCard = document.getElementById("lana-card");


window.onscroll = function () {
    if (window.scrollY >= ours.offsetTop - 300) {
        // console.log("helo");
        text1.style.transform = "translateX(0)";
        text2.style.transform = "translateX(0)";
    }
    if (window.scrollY >= ourTeam.offsetTop - 200) {
        bonnieCard.style.transform = "translateY(0)";
        jeseCard.style.transform = "translateX(0)";
        michaelCard.style.transform = "translateX(0)";
        lanaCard.style.transform = "translateY(0)";
    }
